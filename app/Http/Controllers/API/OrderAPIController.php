...
class OrderAPIController extends Controller
{
     ...
     */
    public function __construct(ProductRepository $productRepo,OrderRepository $orderRepo, ProductOrderRepository $productOrderRepository, CartRepository $cartRepo, PaymentRepository $paymentRepo, NotificationRepository $notificationRepo, UserRepository $userRepository)
    {
    ...
    private function bankakPayment(Request $request){
        ...
        try {
            ...
            foreach ($input['products'] as $productOrder) {
                ...
                //////////get product id to insert 
               $get_product= $productOrder['product_id'];
                     ...
                     /////////////// add identification and RandomId ///
                           ...
                           $identification_market= $this->productOrderRepository->create($productOrder);
                              ...
                              ////////////////get product id to quantity  
                               $g_product_quantity=$identification_market->product->quantity;
                              ////////put value in a variable
                                $quantity = $g_product_quantity;
                              //////////subtracting the existing value from the entered values
            ...
            ////////////////update product Repository quantity///////
            $this->productRepository->update(['quantity' => $quantity] , $get_product );

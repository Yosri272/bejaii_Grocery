            ...
            <div class="row">
                <div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
                    ...
                    <div class="form-group row">
                     ...
                     <!-- app_name ar Field -->
                      <div class="form-group row">
                        {!! Form::label('app_name_ar', trans("lang.app_setting_app_name_ar"), ['class' => 'col-4 control-label text-right']) !!}
                        <div class="col-8">
                            {!! Form::text('app_name_ar', setting('app_name_ar'),  ['class' => 'form-control','placeholder'=>  trans("lang.app_setting_app_name_ar_placeholder")]) !!}
                            <div class="form-text text-muted">
                                {{ trans("lang.app_setting_app_name_ar_help") }}
                            </div>
                        </div>
                    </div>

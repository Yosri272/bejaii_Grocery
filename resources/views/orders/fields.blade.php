...
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
    ...
    <!-- trx_id Field -->
    <div class="form-group row ">
        {!! Form::label('trx_id', trans("lang.order_trx_id"), ['class' => 'col-3 control-label text-right']) !!}
        <div class="col-9">
            {!! Form::number('trx_id', null,  ['readonly','class' => 'form-control', 'step'=>"any",'placeholder'=>  trans("lang.order_trx_id_placeholder")]) !!}
            <div class="form-text text-muted">
                {{ trans("lang.order_trx_id_help") }}
            </div>
        </div>
    </div>
